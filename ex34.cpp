...
{
    short int position = getNumberPositionInArray(arr, Size, ToFind);
    ...
    {
        std::cout << "The number is FOUND at position : " << position++ << '\n';
        std::cout << "The number is FOUND at order    : " << position  << '\n';
    }
}
